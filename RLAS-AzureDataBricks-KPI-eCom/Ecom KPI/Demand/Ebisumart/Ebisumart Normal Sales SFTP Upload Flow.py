...
# MAGIC %md
# MAGIC # This notebook is to upload files to SFTP for eBizumart Normal Sales
...
local_temp_path_prefix: str = "/tmp/demand/normal/ebisumart"

demand_path_outbound_suffix_format: str = os.path.join(demand_normal_path_prefix, "Outbound/ebisumart/JP/{0}")
demand_path_archive_outbound_suffix_format: str = os.path.join(demand_normal_path_prefix, "Archive/Outbound/ebisumart/JP/{0}")
