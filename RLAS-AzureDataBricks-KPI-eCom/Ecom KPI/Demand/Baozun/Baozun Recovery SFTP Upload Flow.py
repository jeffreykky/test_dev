...
# MAGIC %md
# MAGIC # This notebook is to upload files to SFTP for Baozun Recovery
...
local_temp_path_prefix: str = "/tmp/demand/recovery/baozun"

demand_path_outbound_suffix_format: str = os.path.join(demand_recovery_path_prefix, "Outbound/baozun/{0}")
demand_path_archive_outbound_suffix_format: str = os.path.join(demand_recovery_path_prefix, "Archive/Outbound/baozun/{0}")
...
sftp_path: str = "/rl-dna-qa-raw/landing/BizTalk-landing/APAC/CN_HK/Demand"
