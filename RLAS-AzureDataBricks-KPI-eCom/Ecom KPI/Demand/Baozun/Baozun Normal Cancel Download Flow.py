...
# MAGIC %md
# MAGIC # This notebook is to download data for Baozun Normal Cancel Flow
...
#     "version": "1.0",
#     "methodName": "RL_Cancellation_query",
...
for region, shop_id in shop_ids.items():
    ...
    while True:
        ...
        temp_file_name: str = "{}-{}-Cancel-{}.json".format(region, from_order_datetime.strftime("%Y%m%d"), page_number)
